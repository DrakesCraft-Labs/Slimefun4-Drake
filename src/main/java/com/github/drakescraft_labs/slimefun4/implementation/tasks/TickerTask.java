...
import com.github.drakescraft_labs.slimefun4.api.ErrorReport;
...
public class TickerTask implements Runnable {
    ...
    private void reportErrors(Location l, SlimefunItem item, Throwable x) {
        ...
        if (errors == 1) {
            ...
            Slimefun.logger().log(Level.SEVERE, "X: {0,number,#} Y: {1,number,#} Z: {2,number,#} ({3})", new Object[] { l.getBlockX(), l.getBlockY(), l.getBlockZ(), item.getId() });
