...
import com.github.drakescraft_labs.slimefun4.api.exceptions.IdConflictException;
import com.github.drakescraft_labs.slimefun4.api.exceptions.IncompatibleItemHandlerException;
import com.github.drakescraft_labs.slimefun4.api.exceptions.MissingDependencyException;
import com.github.drakescraft_labs.slimefun4.api.exceptions.UnregisteredItemException;
import com.github.drakescraft_labs.slimefun4.api.exceptions.WrongItemStackException;
...
import com.github.drakescraft_labs.slimefun4.core.attributes.Placeable;
...
import com.github.drakescraft_labs.slimefun4.core.handlers.GlobalItemHandler;
...
public class SlimefunItem implements Placeable {
    ...
    private void checkForDeprecations(@Nullable Class<?> c) {
        /*
         * Deprecation checks are disabled for now.
         */
        return;
    }
    ...
    public void registerBlockHandler(String id, @Nonnull BlockHandler handler) {
        addItemHandler(new com.github.drakescraft_labs.slimefun4.core.handlers.BlockBreakHandler(false, false) {
            @Override
    ...
    public final void addOfficialWikipage(@Nonnull String page) {
        ...
        wikiURL = Optional.of("https://web.drakescraft.cl/guia-slimefun.html#" + page);
    }
